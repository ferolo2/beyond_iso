...
def F3mat00(E,L,a0,r0,P0,a2,alpha):
  F00 = Fmat00(E,L,alpha)
  Hi00 = chop(LA.inv(Hmat00(E,L,a0,r0,P0,alpha)))
  return 1/L**3 * chop((1/3*F00 - F00@Hi00@F00))

def F3imat00(E,L,a0,r0,P0,a2,alpha):
  return chop(LA.inv(F3mat00(E,L,a0,r0,P0,a2,alpha)))
